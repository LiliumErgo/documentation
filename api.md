...
All relevant collection data obtained from the frontend is sent to the backend via this API. The necessary contracts are then compiled and AVL tree data is uploaded to the database.
...
<img src="images/db.png" alt="drawing" style="width:700px;"/>
